...
<style>
    #invoice-POS{box-shadow:0 0 1in -.25in rgba(0,0,0,.5);padding:2mm;margin:0 auto;width:100mm;background:#fff;color:#222}h2{font-size:1.4em}h3{font-size:1.6em;font-weight:400;line-height:2em}
    ...
    <div id="bot">
					...
					<div id="table">
						<table>
							...
							<tr class="service">
								<td class="tableitem">
                                    <p class="pTag" class="itemtext" id="passenger">
                                        Koko Pimentel
                                        <br> Senior/PWD:
                                        <br> Insurance: NONE
								...
								<td class="tableitem">
                                    <p class="pTag" class="itemtext" id="passengerSubTotal">
                                        $120
                                        <br>
                                        <br>
                                        <br>
